	...
	public static void main(String[] args) {
		...
		if(solvedAnyRepls)
		{
			...
			if(noOfReplsSolved>=17)
			{
				...
				System.out.println("You arre doing ok PLease complete theem as soon as possible");
			}else {
		...
		{
			System.out.println("They are very impotant to learn java please solve them");
		}
	}
